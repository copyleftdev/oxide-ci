...
use oxide_core::run::*;
use oxide_spec::{spec_link, SpecLinked, SpecValidator};

// Link Rust types to their AsyncAPI schemas
spec_link!(RunQueuedPayload, schema = "RunQueuedPayload", file = "schemas/run.yaml");
spec_link!(RunStartedPayload, schema = "RunStartedPayload", file = "schemas/run.yaml");
spec_link!(RunCompletedPayload, schema = "RunCompletedPayload", file = "schemas/run.yaml");
spec_link!(RunCancelledPayload, schema = "RunCancelledPayload", file = "schemas/run.yaml");

spec_link!(StageStartedPayload, schema = "StageStartedPayload", file = "schemas/stage.yaml");
spec_link!(StageCompletedPayload, schema = "StageCompletedPayload", file = "schemas/stage.yaml");

spec_link!(StepStartedPayload, schema = "StepStartedPayload", file = "schemas/step.yaml");
spec_link!(StepOutputPayload, schema = "StepOutputPayload", file = "schemas/step.yaml");
spec_link!(StepCompletedPayload, schema = "StepCompletedPayload", file = "schemas/step.yaml");

spec_link!(CacheHitPayload, schema = "CacheHitPayload", file = "schemas/cache.yaml");
spec_link!(CacheMissPayload, schema = "CacheMissPayload", file = "schemas/cache.yaml");
spec_link!(CacheUploadedPayload, schema = "CacheUploadedPayload", file = "schemas/cache.yaml");
spec_link!(CacheEvictedPayload, schema = "CacheEvictedPayload", file = "schemas/cache.yaml");

spec_link!(PipelineDefinition, schema = "PipelineDefinition", file = "schemas/pipeline.yaml");
spec_link!(StageDefinition, schema = "StageDefinition", file = "schemas/pipeline.yaml");
spec_link!(StepDefinition, schema = "StepDefinition", file = "schemas/pipeline.yaml");
